...
/**
 * Created by leslie on 19/04/2016.
 */
public class LostUI implements Initializable, Serializable {
    ...
    private Button disPerson, disAnimal, lost, found, adopt, addAnimal, addImageBtn, btnMain;
    ...
    public LostUI() {
        ...
        animalBreeds = new File("src\\files\\breed.txt");
    ...
    public ObservableList loadSerializedAnimal() {
        ...
        theAnimals.clear();
        animalList = serial.deSerializeAnimalLostList();
    ...
    public ObservableList loadSerializedPerson() {
        ...
        persons.clear();
        personList = newSerial.deSerializePersonLostList();
    ...
    public void addToList() {
        ...
        Category lostAnimal = new Lost(datePicker.getValue(), person, cmbLocations.getValue());
        animal.setAnimalCat(lostAnimal);
...
// Scale the iamge to 200 X 100
    ...
    public BorderPane borderPane() {
        ...
        saveToFile.setOnAction(event -> {
            serial.serializeAnimalLostList(animalList);
            serial.serializePersonLostList(personList);
